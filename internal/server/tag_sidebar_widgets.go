...
func (s *Server) tagCategoryList(ctx context.Context, ev *template.Evaluator, el *parse.Node) (*parse.Node, error) {
...
func (s *Server) tagArchiveList(ctx context.Context, ev *template.Evaluator, el *parse.Node) (*parse.Node, error) {
...
func (s *Server) tagPageList(ctx context.Context, ev *template.Evaluator, el *parse.Node) (*parse.Node, error) {
...
// scope chain.
func (s *Server) tagMetaLinks(ctx context.Context, ev *template.Evaluator, el *parse.Node) (*parse.Node, error) {
...
func (s *Server) tagSearchForm(ctx context.Context, ev *template.Evaluator, el *parse.Node) (*parse.Node, error) {
...
func (s *Server) tagArchiveHeader(ctx context.Context, ev *template.Evaluator, el *parse.Node) (*parse.Node, error) {
